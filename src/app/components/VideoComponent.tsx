...
const VideoComponent = () => {
  ...
  return (
    <div className='w-full h-auto flex flex-col justify-center items-center py-0 lg:py-20 dark:bg-custom-dark bg-custom-light relative space-y-0'>
      <div className='w-full lg:h-full justify-center items-center px-0 lg:px-[74px] h-[280.694px] lg:flex'>
          ...
          <div className='w-full h-full absolute top-0 left-0 flex justify-center items-center'>
            {isPlaying ? (
              <Image
                src={pauseBtn}
                alt='play btn'
                className='cursor-pointer opacity-[.3] hover:opacity-100 transition-opacity duration-300 ease-in-out scale-[.8] lg:scale-1'
