...
const OurHistory = () => {
  return (
    <div className="w-full h-auto px-[74px] grid grid-cols-2 items-center relative">
      <div className="flex flex-col space-y-8 items-start">
        <p className="font-kingstone text-[#AF6900] text-[18px] tracking-[6.3px] uppercase leading-[18px]">
          Don Alvaro
        </p>
        <h3 className="font-brand text-[#A5886D] text-[60px] leading-[60px]">
          Our History
        </h3>
        <div className="flex flex-col space-y-5">
          <p className="font-georgia text-white text-[20px] leading-[32px] w-[80%]">
        ...
        <button className="font-kingstone text-[#FAF7F2] bg-[#AF6900] rounded-[4.427px] flex justify-center items-center px-10 py-3 text-[16.821px] text-center leading-normal">
          See more
        </button>
      </div>

      <div className="flex flex-col items-center justify-center h-full py-[6rem]">
        <div className="w-auto h-auto justify-center items-center z-10 relative">
          <Image
