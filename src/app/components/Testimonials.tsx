...
const Testimonials = () => {
  return (
    <div className='w-full h-auto flex justify-center items-center pt-20 pb-[10rem] bg-[#232323]'>
        ...
        <div className='w-full h-full flex justify-center items-center '>
          <div className='w-[80%] flex flex-col space-y-[3rem] justify-start relative'>
            ...
            <div className='flex space-x-10 justify-center items-center w-full'>
              ...
              />
                <div
                  className='testimonial-pagination space-x-3 flex justify-center items-center bg-transparent w-full'
                />
              <Image
